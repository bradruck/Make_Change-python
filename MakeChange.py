...
def ways(amount, i, solutions, coin, answer):
    ...
    if i != amount:
        ...
        total_ways += 1       # Increment total number of solutions
    return
...
def main():
    ...
    global total_ways       # Track the amount of solutions calculated
...
Please enter 'Y' for yes or 'N' for no: ''')
    ...
    if amount > 0:
        ...
        ways(amount, start_coins, solutions, coin, answer)
        ...
        if answer == 'Y' or answer == 'y':
            print()
            print("Total unique coin combinations: ", total_ways)
        else:
            print()
            print("Total recursive coin combinations: ", total_ways)
